...
export default function Home() {
  ...
  const biographies = [
    ...
    },
    {
      ...
      description: "Андрей был призван защищать Родину в сентябре 2022 года, служил наводчиком мотострелкового отделения. Он погиб 13 января 2026 года в районе населённого пункта Плехово Суджанского района Курской области.",
